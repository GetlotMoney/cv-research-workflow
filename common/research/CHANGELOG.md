...
> 历史记录，不能作为当前操作说明。当前使用方法见系统根目录 `README.md`。

## [V1.0] - 2026-07-29（当前正式版本）

- 发布没有个人实例的通用科研模板。
- 六个方向身份齐全，只有 GZSL 开放。
- 当前唯一主线为 Framework、四类实验、GPU Run 和人工确认。
- 外来 GZSL Framework 支持扫描、标准化、中央 CUDA 检查和等价重跑。
- 当前文档、历史记录和测试材料已经分层管理。
